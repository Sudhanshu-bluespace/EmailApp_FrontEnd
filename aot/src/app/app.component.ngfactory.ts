...
import * as import8 from '../../../src/app/home/home.component';
import * as import9 from './home/home.component.ngfactory';
import * as import10 from '@angular/router/src/router';
import * as import11 from '../../../src/app/security/login/login.service';
import * as import12 from '../../../src/app/core/global.service';
import * as import13 from '../../../src/app/core/authorization.service';
...
export class View_AppComponent0 extends import1.AppView<import0.AppComponent> {
  _el_0:any;
  compView_0:import1.AppView<import8.HomeComponent>;
  _HomeComponent_0_3:import9.Wrapper_HomeComponent;
  _text_1:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._el_0 = import3.createRenderElement(this.renderer,parentRenderNode,'home-comp',import3.EMPTY_INLINE_ARRAY,(null as any));
    this.compView_0 = new import9.View_HomeComponent0(this.viewUtils,this,0,this._el_0);
    this._HomeComponent_0_3 = new import9.Wrapper_HomeComponent(this.parentView.injectorGet(import10.Router,this.parentIndex),this.parentView.injectorGet(import11.LoginService,this.parentIndex),this.parentView.injectorGet(import12.GlobalService,this.parentIndex),this.parentView.injectorGet(import13.AuthorizationService,this.parentIndex));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import8.HomeComponent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._HomeComponent_0_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
